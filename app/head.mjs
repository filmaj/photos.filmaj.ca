export default function Head(state) {
  ...
  const { pageTitle = 'Photos by Fil Maj' } = store;
  const description = `Fil Maj's photography archive.`;
  ...
  return `
    ...
    <head>
      ...
      <meta name="og:site_name" content="Photos by Fil Maj" />
      <meta name="og:type" content="website" />
      <link rel="me" href="https://social.lunchlurkers.com/@filmaj">
      <link rel="stylesheet" type="text/css" href="https://filmaj.ca/_public/css/reset.css">
      <link rel="stylesheet" type="text/css" href="https://filmaj.ca/_public/css/filmaj.css">
